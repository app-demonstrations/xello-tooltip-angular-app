import { ContentOptions } from './tooltip.options';
...
export class TooltipContentComponent implements AfterContentChecked {
  ...
  ngAfterContentChecked() {
    const toolTipWidth: number = this.elRef.nativeElement.querySelector('div.ng-tool-tip-content').offsetWidth;
